      ...
      <Container className="legal-defense-background">
         <Row>
            <Col md={6} style={{ color: 'white' }} className="mt-3">
               ...
               <p className="text-start all-text-font-size">Se realiza el estudio de los actos de autoridad en particular y se define una estrategia legal que permita lograr el mejor beneficio de sus intereses.</p>
